...
function startGame() {
    ...
    for(var i = 0; i< 5;i++){
      ...
      myObstacles[5] = new componentObstacle(40, 40,  myGameArea.canvas.width, myGameArea.canvas.height/2 , 5, 0, 1, "attack");
...
function boostWeapon(){
  if(myGamePieceLife < 95){
    myObstacles[6] = new componentObstacle(61, 61,  myGameArea.canvas.width, 20, 0, 4, 1, "booster");
    myObstacles[7] = new componentObstacle(100, 80,  myGameArea.canvas.width, 0, 0, 4, 1, "boosterVehicle");
...
function newAttack(){
  ...
  if(obsCount > 0){
    myObstacles[5] = new componentObstacle(40, 40,  myGameArea.canvas.width, (myGameArea.canvas.height/newRandYPos +20), 5, 0, leftOrRight, "attack");
  }
}
    ...
    this.newPos = function() {
      ...
      if(score == 250){
        ...
        setTimeout(function(){
          ...
          var birdsAudio = document.getElementById("birdsAudio");
          birdsAudio.play();
